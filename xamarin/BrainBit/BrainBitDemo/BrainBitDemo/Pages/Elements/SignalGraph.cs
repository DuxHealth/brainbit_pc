...
internal class SignalGraph : SKCanvasView
{
    public SignalGraph()
    {
    ...
    public void Init(int maxWindow, int samplingFrequency, string name)
    {
    ...
    private void DrawAxis(SKCanvas canvas)
    {
        ...
        canvas.DrawText(_name, (x - _ampTextRect.Width) / 2, _abscissa, _textPaint);
...
#region Properties
    ...
    public static BindableProperty FPSProperty = BindableProperty.Create(
        propertyName: nameof(FPS),
        returnType: typeof(int),
        declaringType: typeof(SignalGraph),
        defaultValue: 30
    );
...
#region Variables
    ...
    private readonly Point _padding = new(10.0f, 10.0f);
