...
[assembly: Dependency(typeof(BrainBitDemo.Droid.Utils.SensorHelper))]

namespace BrainBitDemo.Droid.Utils;
...
#region ISensorHelper Members
    ...
    private void TurnOnBt()
    {
        ...
        if (btManager != null && !btManager.Adapter.IsEnabled)
        {
            MessagingCenter.Subscribe<MainActivity, bool>(
                this,
                "EnableBT",
    ...
    private static bool IsGooglePlayServicesAvailable(Context context)
    {
