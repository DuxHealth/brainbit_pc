...
std::string SampleCallibri::readName()
{
	try
	{
...
bool SampleCallibri::writeName(std::string name)
{
	try
	{
		//Check if our sensor is empty or not.
...
SensorState SampleCallibri::readState()
{
	try
	{
		//Check if our sensor is empty or not.
...
std::string SampleCallibri::readAddress()
{
	try
	{
		//Check if our sensor is empty or not.
...
std::string SampleCallibri::readSerialNumber()
{
	try
	{
		//Check if our sensor is empty or not.
...
bool SampleCallibri::writeSerialNumber(std::string serialNumber)
{
	try
	{
		//Check if our sensor is empty or not.
...
CallibriColorType SampleCallibri::readColor()
{
	try
	{
		//Check if our sensor is empty or not.
		...
		CallibriColorType colorType;

		OpStatus outStatus;

		bool result = readColorCallibri(_sensor, &colorType, &outStatus);
...
SensorVersion SampleCallibri::readVersion()
{
	try
	{
		//Check if our sensor is empty or not.
...
int32_t SampleCallibri::readBatteryPower()
{
	try
	{
		//Check if our sensor is empty or not.
...
int32_t SampleCallibri::getChannelsCount()
{
	try
	{
		//Check if our sensor is empty or not.
...
SensorFamily SampleCallibri::getFamily()
{
	try
	{
		//Check if our sensor is empty or not.
