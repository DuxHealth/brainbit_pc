...
std::vector<SensorFeature> SampleCallibri::getSupportedFeatures()
{
	try
	{
...
std::vector<SensorCommand> SampleCallibri::getSupportedCommands()
{
	try
	{
		//Check if our sensor is empty or not.
...
std::vector<ParameterInfo> SampleCallibri::getSupportedParameters()
{
	try
	{
		//Check if our sensor is empty or not.
...
bool SampleCallibri::isSupportedFeature(SensorFeature feature)
{
	try
	{
		//Check if our sensor is empty or not.
...
bool SampleCallibri::isSupportedCommand(SensorCommand command)
{
	try
	{
		//Check if our sensor is empty or not.
...
bool SampleCallibri::isSupportedParameter(SensorParameter parameter)
{
	try
	{
		//Check if our sensor is empty or not.
