...
//  BrainBitDemo
//
//  Created by Aseatari on 07.12.2023.
//

import Foundation
import CorePlot

class SpectrumGraphView: CPTGraphHostingView, CPTPlotDataSource, CPTPlotSpaceDelegate {
    
    var plotData : NSMutableArray = [0.0]
    var currentIndex: Int!
    var plot: CPTScatterPlot!
    
    func initGraph(samplingFrequency: Int) {
